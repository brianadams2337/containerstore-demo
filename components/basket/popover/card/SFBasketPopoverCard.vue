  ...
  >
    ...
    >
      <div class="mr-5 flex flex-1">
        <SFBasketPopoverCardImage :item="mainItem" />
        <SFBasketPopoverCardBaseInfo
          :item="mainItem"
          :is-light-variant="isLightVariant"
          class="ml-2"
        />
      </div>
      <SFBasketPopoverCardPrice :item="mainItem" />
    </SFLocalizedLink>
    <SFAddOnItems
...
import SFBasketPopoverCardImage from './SFBasketPopoverCardImage.vue'
import SFBasketPopoverCardBaseInfo from './SFBasketPopoverCardBaseInfo.vue'
import SFBasketPopoverCardPrice from './SFBasketPopoverCardPrice.vue'
