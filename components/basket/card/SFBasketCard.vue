  ...
  <SFFadeInTransition>
    ...
    >
      ...
      <div v-if="addOnItems.length" class="ml-8 mt-8 overflow-hidden">
        <SFAddOnItems :items="addOnItems" />
      </div>
    </div>
    <SFBasketCardConfirmDelete
...
import SFAddOnItems from '../addOns/SFAddOnItems.vue'
import SFBasketCardDetail from './SFBasketCardDetail.vue'
import SFBasketCardConfirmDelete from './SFBasketCardConfirmDelete.vue'
import SFBasketCardAction from './SFBasketCardAction.vue'
...
import SFProductCardBadgesFooter from '~/components/product/card/badges/SFProductCardBadgesFooter.vue'
