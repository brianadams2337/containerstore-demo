<template>
  <div class="flex w-full items-center justify-start gap-x-3">
    <SFLocalizedLink
      ...
      :key="`${title}-${index}`"
      class="inline-block w-fit rounded-md px-2 py-1.5 text-lg font-semi-bold-variable tracking-tighter text-gray-600 duration-300 ease-out hover:bg-gray-100 focus-visible:transition-none"
