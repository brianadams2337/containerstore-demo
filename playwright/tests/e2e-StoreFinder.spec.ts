...
test.skip('C2161318: Verify find store by city', async ({
  page,
  mobileNavigation,
  storeLocator,
}) => {
...
test.skip('C2161319: Verify find store by ZIP code', async ({
  page,
  mobileNavigation,
  storeLocator,
}) => {
...
test.skip('C2161368: Verify find store by invalid ZIP code', async ({
  page,
  mobileNavigation,
  storeLocator,
}) => {
